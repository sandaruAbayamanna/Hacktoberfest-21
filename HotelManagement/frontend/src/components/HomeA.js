                                ...
                                <div class="p-3 border bg-white" >
                                    <div class="card" style={{width: 'auto'}}>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="/hres" class="btn btn-dark">Go to Reservation Management</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="p-3 border bg-white" >
                                    <div class="card" style={{width: 'auto'}}>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="/Emp" class="btn btn-dark">Go to Employee Management</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="p-3 border bg-white" >
                                    <div class="card" style={{width: 'auto'}}>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="/AllServices" class="btn btn-dark">Go to Extra Facilities Management</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="p-3 border bg-white" >
                                    <div class="card" style={{width: 'auto'}}>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="/FeedbackHome" class="btn btn-dark">Go to Feedback Management</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
