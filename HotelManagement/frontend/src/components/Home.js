  ...
  render() {
    return (
      ...
      <div className="container">
          ...
          <tbody>
            {this.state.posts.map((posts, index) => (
              <tr key={index}>
                ...
                <td>
                  <a className="btn btn-outline-success" href={`/editf/${posts._id}`}>
        ...
        {<button className="btn btn-success"><a href="/FRepo" style={{ textDecoration: 'none', color: 'white' }}>Generate Report</a></button>}
      </div>
